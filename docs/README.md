...
- 项目最小入口：[`../CONTEXT.md`](../CONTEXT.md)
- 完整产品需求：[`product/novelx-desktop-product-requirements.md`](product/novelx-desktop-product-requirements.md)
...
阅读原则：产品文档说明“最终要做什么”，架构文档说明“长期怎么做”，`notes/status/` 和当前状态文档说明“现在真实做到了什么”。三者不能互相代替。
